...
//                                     <li><button class="dropdown-item" type="button"><img class="tools-icon" src="../assets/images/arrange icon.png" alt="">Arrange PDF files</button></li>
//                                     <li><button class="dropdown-item" type="button"><img class="tools-icon" src="../assets/images/edit-icon.png" alt="">View & Edit PDF</button></li>
//                                     <li><button class="dropdown-item" type="button"><img class="tools-icon" src="../assets/images/convert icon.png" alt="">PDF conversion</button></li>
//                                     <li><button class="dropdown-item" type="button"><img class="tools-icon" src="../assets/images/draw-icon.png" alt="">Sign</button></li>
//                                   </ul>
//                               </li>
//                             </ul>
...
//                             <img class="ms-3" src="../assets/images/EzPDF.jpg" style="height: 3rem; width: 4rem;" alt="">
//                           </div>
//                         </div>
//                       </nav>
//                 ` 
